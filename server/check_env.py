...
# Pinecone 설정 확인
print("\n[Pinecone 설정]")
print(f"  PINECONE_SEARCH_ENABLED: {os.getenv('PINECONE_SEARCH_ENABLED', '없음')}")
print(f"  PINECONE_API_KEY: {'설정됨' if os.getenv('PINECONE_API_KEY') else '없음'}")
print(f"  PINECONE_INDEX_NAME: {os.getenv('PINECONE_INDEX_NAME', '없음')}")
...
try:
    ...
    print(f"\n[config.py 값]")
    print(f"  PINECONE_SEARCH_ENABLED: {PINECONE_SEARCH_ENABLED}")
